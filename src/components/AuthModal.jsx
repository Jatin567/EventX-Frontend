...
const AuthModal = ({ isOpen, onClose, initialType = 'login' }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (type === 'login') {
                const res = await axios.post('https://eventx-backend-3.onrender.com/api/auth/login', {
                ...
                const res = await axios.post('https://eventx-backend-3.onrender.com/api/auth/register', payload);
